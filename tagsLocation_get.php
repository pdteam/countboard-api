...
$sql = "select * from countboard.tags where tagtype = ? and facility = ? and location = ? and active = 1";
$params = array( "location", $facility, $location ); 		//establishing params prevents SQL Injection into the DB}
